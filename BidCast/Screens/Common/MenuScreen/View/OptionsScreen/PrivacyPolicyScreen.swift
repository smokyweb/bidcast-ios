    ...
    var body: some View {
        ZStack {
            VStack(spacing: 0, content: {
                PrimaryHeader(title: "Privacy Policy", leadingImgArr: [.sideArrow], trailingImgArr: [.notification,.sideMenu], onClickLeading: { _ in
                ...
                VStack(alignment: .leading) {
                    TitleWithLine(title: "Privacy Policy", lineLength: 36)
