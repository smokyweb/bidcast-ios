...
//                if showSpinwheel {
//                    FortuneWheel(titles: viewModel.options,
//                                 size: 320,
//                                 onSpinEnd: onSpinEnd,
...
////        let winner = viewModel.options.randomElement() ?? ""
//        
...
//                
//                // Send chat message (integrate with your chat system)
//                // ChatService.sendSystemMessage("Randomizer winner: \(winner)")
//                
...
////    private let centerCircleSize: CGFloat = 80
////    
////    var colors: [Color] {
////        [.red, .purple, .yellow, .blue, .green, .orange, .pink, .cyan, .indigo, .mint]
////    }
////    
////    var body: some View {
////        ZStack {
...
////                    .animation(
////                        isSpinning ? .linear(duration: 0.8).repeatForever(autoreverses: false) : .default,
////                        value: isSpinning
////                    )
////            }
////            
...
//            // Segment shape
//            Circle()
//                .trim(from: 0, to: CGFloat(1.0 / Double(totalSegments)))
//                .fill(color)
//                .rotationEffect(.degrees(Double(index) * angle - 90))
//            
//            // Text label
//            Text(text)
//                .font(.custom(poppinsSemiBold, size: textSize))
//                .foregroundColor(.white)
//                .lineLimit(1)
//                .minimumScaleFactor(0.5)
//                .frame(width: 80)
//                .rotationEffect(.degrees(Double(index) * angle + angle / 2))
//                .offset(y: -120)
//        }
//    }
//    
...
//            .background(
//                RoundedRectangle(cornerRadius: 12)
//                    .fill(isDisabled ? Color.gray.opacity(0.3) : Color.white.opacity(0.2))
//            )
//            .overlay(
//                RoundedRectangle(cornerRadius: 12)
...
//    }
//    
//    func loadViewersAsOptions() {
//        // TODO: Integrate with your viewer data model
//        // Example: options = ViewerService.getEligibleViewers()
//    }
//}
//
//// MARK: - Extensions
