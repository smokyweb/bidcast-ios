//
//  InterestedCandidateScreen.swift
//  imperium
//
//  Created by JAM-E-221 on 21/10/24.
//

import SwiftUI
import AlertToast

struct InterestedCandidateScreen: View {
    ...
    var body: some View {
        ZStack {
            VStack(spacing: 0, content: {
                PrimaryHeader(title: "My Interests", leadingImgArr: [.sideArrow], trailingImgArr: [.notification,.sideMenu], onClickLeading: { _ in
                ...
                VStack(alignment: .leading){
                        ...
                        TitleWithLine(title: "Interest Candidates", lineLength: 36)
