...
//
//
//struct FilterEmployerRequestModal: Codable {
...
//
//
//struct FilterEmployerOptionView: View {
...
//                                withAnimation {
//                                    cate = ""
//                                    filterRequest = FilterRequestModal(location: "", job_title: "", company_name: "", job_description: "", category: 0, job_id: 0, salary: "", benefit: "")
...
//                            isOutLine: false,
//                            onButtonClick: {
//                                validateFilterEmployer()
//                                
//                            }, width: screenWidth/1.5 - 30)
//                    }
//                    .padding(.vertical)
//                    .padding(.top, isEmployee ? screenHeight/4 : screenHeight/4)
//                }.padding(.horizontal)
//            }
////            Spacer()
//        }
