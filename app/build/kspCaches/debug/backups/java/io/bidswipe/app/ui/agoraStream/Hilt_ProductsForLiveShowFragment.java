...
public abstract class Hilt_ProductsForLiveShowFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductsForLiveShowFragment() {
    super();
  }

  Hilt_ProductsForLiveShowFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductsForLiveShowFragment_GeneratedInjector) this.generatedComponent()).injectProductsForLiveShowFragment(UnsafeCasts.<ProductsForLiveShowFragment>unsafeCast(this));
    }
  }
