...
public abstract class Hilt_SearchUsers extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchUsers_GeneratedInjector) this.generatedComponent()).injectSearchUsers(UnsafeCasts.<SearchUsers>unsafeCast(this));
    }
  }
