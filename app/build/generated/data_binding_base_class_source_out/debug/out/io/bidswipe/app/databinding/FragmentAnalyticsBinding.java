...
public final class FragmentAnalyticsBinding implements ViewBinding {
  ...
  private FragmentAnalyticsBinding(@NonNull ConstraintLayout rootView, @NonNull TextView bio,
      @NonNull Header header, @NonNull MaterialCardView iconCard, @NonNull ViewPager2 pager,
      @NonNull AppCompatImageView profileImage, @NonNull TabLayout tabs,
  ...
  public static FragmentAnalyticsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAnalyticsBinding((ConstraintLayout) rootView, bio, header, iconCard, pager,
          profileImage, tabs, userName);
    }
